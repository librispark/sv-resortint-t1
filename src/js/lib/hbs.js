        ...
        load: function (name, parentRequire, load, config) {
          //>>excludeStart('excludeHbs', pragmas.excludeHbs)
                      ...
                      helpDepStr = (function (){
                        var i, paths = [],
                            pathGetter = config.hbs && config.hbs.helperPathCallback
                              ...
                              : function (name){return ('app/views/templates/helpers/') + name;};
            ...
            if (disableI18n){
                ...
                fetchOrGetCached( parentRequire.toUrl(('app/views/templates/i18n/')+(config.locale || "en_us")+'.json'), function (langMap) {
